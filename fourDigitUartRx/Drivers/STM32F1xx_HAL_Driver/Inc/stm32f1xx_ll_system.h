...
#define LL_FLASH_LATENCY_2                 FLASH_ACR_LATENCY_1     /*!< FLASH Two wait states */
    ...
    LL_DBGMCU_EnableDBGSleepMode (void)
    {
     ...
     */
    __STATIC_INLINE void
    LL_DBGMCU_DisableDBGSleepMode (void)
    {
     ...
     */
    __STATIC_INLINE void
    LL_DBGMCU_SetTracePinAssignment (uint32_t PinAssignment)
    {
     ...
     */
    __STATIC_INLINE void
    LL_FLASH_EnableHalfCycleAccess (void)
    {
     ...
     */
    __STATIC_INLINE void
    LL_FLASH_DisableHalfCycleAccess (void)
    {
     ...
     */
    __STATIC_INLINE uint32_t
    LL_FLASH_IsHalfCycleAccessEnabled (void)
    {
